...
#### Example:
Suppose one doctor writes "Mild", another writes "Mod", and a third writes "1" to describe the severity of an event. Without CT, these would all be treated as different, even though they mean the same thing. With CDISC CT, everyone must use the same set of allowed values, like **"MILD", "MODERATE", "SEVERE"**.
